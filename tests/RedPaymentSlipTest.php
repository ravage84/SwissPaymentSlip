...
class RedPaymentSlipTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage Argument 1 passed to SwissPaymentSlip\SwissPaymentSlip\RedPaymentSlip::__construct() must be an instance of SwissPaymentSlip\SwissPaymentSlip\PaymentSlipData, null given
     */
     ...
     * @covers ::__construct
     * @expectedException \PHPUnit_Framework_Error
     * @expectedExceptionMessage Argument 1 passed to SwissPaymentSlip\SwissPaymentSlip\RedPaymentSlip::__construct() must be an instance of SwissPaymentSlip\SwissPaymentSlip\PaymentSlipData, instance of ArrayObject given
     */
    ...
    public function testSetSlipBackground()
    {
        ...
        $this->paymentSlip->setSlipBackground(__DIR__.'/Resources/img/ezs_red.gif');
        $this->assertEquals(__DIR__.'/Resources/img/ezs_red.gif', $this->paymentSlip->getSlipBackground());
    }
    ...
    {
        $slipData = new RedPaymentSlipData('red');
        $this->paymentSlip = new RedPaymentSlip($slipData);
